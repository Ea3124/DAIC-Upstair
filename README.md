...
## 📌 개요
장학금 매칭 시스템은 사용자가 입력한 기본 프로필 정보를 바탕으로, 조건에 부합하는 장학금을 자동으로 찾아주는 서비스이다. 공고문은 PDF, DOCX, HWP 등 다양한 문서 형식을 지원하며, 업스테이지 Document Parser를 활용해 자동 분석된다. 사용자는 앱 내에서 LLM 기반의 지원서 자동 작성 기능을 통해 손쉽게 신청서를 작성할 수 있으며, 맞춤형 알림과 챗봇 기능을 통해 편리하게 장학금 정보를 확인하고 지원할 수 있다.
